...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-500 via-gray-200 to-sky-600 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Login form */}
        <form onSubmit={handleLogin} className="bg-white/10 backdrop-blur-lg p-5 rounded-2xl shadow-2xl bg-gradient-to-br from-sky-500 via-gray-800 to-sky-600 px-4 relative overflow-hidden" noValidate>
          {error ? (
            <div className="bg-red-500/20 border border-red-500/30 text-red-100 text-sm p-3 rounded-lg mb-6 backdrop-blur-sm">
              {error}
            </div>
          ) : (
            <p className="text-white/70 text-sm mb-6 text-center">Enter your credentials to continue</p>
          )}
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              {/* <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-white/60 z-10" /> */}
          ...
          <button
            type="submit"
            disabled={submitting}
            className={`w-full py-3 rounded-xl font-semibold text-white transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-white/30 ${submitting
