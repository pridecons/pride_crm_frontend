        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {Object.entries(overall_stats)
              // remove conversion_rate card
              .filter(([key]) => key !== 'conversion_rate')
              // remap titles: new_leads_* → upload_leads_*
              .map(([key, value]) => {
          ...
          {Array.isArray(data?.daily_trends) &&
            ...
            (() => {
              ...
              for (const row of data.daily_trends) {
                ...
                monthlyRevenue.set(
                  key,
                  (monthlyRevenue.get(key) || 0) + Number(row.revenue || 0)
                )
              }
