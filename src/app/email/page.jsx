...
export default function EmailTemplates() {
  ...
  const editor = useEditor({
    ...
    extensions: [StarterKit, Link, TextStyle, FontSize],
    content: "",
    onUpdate: ({ editor }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editTemplate) {
        await axiosInstance.put(`/email/templates/${editTemplate.id}`, formData);
        toast.success("Template updated successfully");
      } else {
        await axiosInstance.post("/email/templates/", formData);
