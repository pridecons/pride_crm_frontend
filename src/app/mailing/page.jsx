...
export default function InternalMailingForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // NOTE: Keeping your original logic intact (no functional change)
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              color: "var(--theme-muted-contrast)",
              borderColor: "var(--theme-border)",
            }}
          >
              ...
              <div className="px-4 py-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    {!mode ? (
                      <select
                        className={`${fieldBase} px-2 py-1 text-sm`}
                        style={selectStyle}
                        value={mode}
                        onChange={(e) => {
                  ...
                  {loading ? (
                    <>
                      <div
                        ...
                        style={{
                          border: "2px solid color-mix(in oklab, var(--theme-primary-contrast) 40%, transparent)",
