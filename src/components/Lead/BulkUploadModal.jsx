                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-5 border border-green-200">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-gray-800">{uploadResult.total_rows}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Successfully Uploaded</span>
                      <span className="font-semibold text-green-600">{uploadResult.successful_uploads}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Duplicates Skipped</span>
                      <span className="font-semibold text-yellow-600">{uploadResult.duplicates_skipped}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Errors</span>
                      <span className="font-semibold text-red-600">{uploadResult.errors.length}</span>
                    </div>
                  </div>
                </div>
