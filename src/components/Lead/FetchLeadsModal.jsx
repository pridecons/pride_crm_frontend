    ...
    const handleFetch = async () => {
        ...
        try {
            ...
            const apiMsg =
                ...
                error?.message;
            // If you want to force your message regardless of `error`, omit `error` prop:
                                    ...
                                    sources
                                        ...
                                        .map((s) => {
                                            ...
                                            return (
                                                <tr
                                                    key={s.source_id}
                                                    className={`cursor-pointer transition-all ${isSelected ? "bg-blue-50/50" : "hover:bg-gray-50"
                                                        }`}
