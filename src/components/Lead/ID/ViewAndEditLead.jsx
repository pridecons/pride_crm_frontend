          ...
          <div>
            ...
            {isEditMode ? (
              ...
              <InputField
                ...
                isEditMode
                onInputChange={(e) => {
                  handleLeadResponseChange(currentLead, e.target.value);
                  setEditFormData((p) => ({
                    ...p,
                    lead_response_id: e.target.value,
                  }));
                }}
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setEditFormData((p) => ({ ...p, lead_response_id: newVal }));
                  handleLeadResponseChange(currentLead, newVal); // trigger backend patch immediately
                }}
