...
const LABEL_OVERRIDES = {
  ...
  user_all_branches: "All Branches (User)",
  ...
  lead_branch_view: "Lead Branch View",
  ...
  client_select_branch: "Client Select Branch",
  ...
  branch_agreement_view: "Branch Agreement View",
